...
class BookingManageCPTPage extends ManageCPTPage {
	...
	public function renderColumns( $column, $postId ){
		...
		switch ( $column ) {
			case 'id':
				printf( '<a href="%s"><strong>' . esc_html__( 'Booking #%s', 'motopress-hotel-booking' ) . '</strong></a>', esc_url( get_edit_post_link( $postId ) ), esc_html( $postId ) );
				break;
			case 'status':
			...
			case 'check_in_out_date' :
				...
				if ( !is_null( $checkInDate ) && !is_null( $checkOutDate ) ) {
					...
					?><em><?php echo esc_html( sprintf( _n( '%s night', '%s nights', $nights, 'motopress-hotel-booking' ), $nights ) ); ?></em><?php
				}
                        ...
                        <?php if ( $customer ) : ?>
                            <?php
                                ...
                                if ( !empty( $customer->getEmail() ) ) {
                                    ...
                                    $customerInfo .= '<br />'
                                        . '<a href="mailto:' . esc_attr( $customer_email ) . '">'
                                ...
                                if ( !empty( $customer->getPhone() ) ) {
                                    $customerInfo .= '<br />'
                                        . '<a href="tel:' . esc_attr( $customer->getPhone() ) . '">'
